    ...
    return (
      <div className="flex justify-center items-center mt-20">
        ...
        <div className="font-semibold">
          ...
          <div className="pb-3">
            Soil Request Number: {this.props.data.productionOrderId}
          </div>
          <div className="pb-3">
            Driver Name: {this.props.data.driver?.driverName}
          </div>
          <div className="pb-3">
            Trip Date: {formatDate(this.props.data.date)}
          </div>
          <div className="pb-3">
            Vehicle Plate Number: {this.props.data.vehicle.vehiclePlateNumber}
          </div>
        </div>
      </div>
    );
...
export default function TripQrCodeModal({
  title,
  closeModal,
  saveFcn,
  type,
  ...
  const datalog = `${APP_URL}/gate-pass-jubila/EnterRequest/${data.id}`;
  ...
  const codeData = {
    ...
    vehiclePlateNumber: data.vehicle.vehiclePlateNumber,
  };
