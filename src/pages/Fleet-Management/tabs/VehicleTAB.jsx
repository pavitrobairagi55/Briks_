...
export default function VehicleTAB() {
  ...
  const deleteVehicle = async () => {
    try {
      await axios.delete(`api/Vehicles/${selectedId}`, {
        headers: {
  ...
  const rows = data?.map((elem) => {
    return {
      id: elem.id,
      ID: elem.id,
      VehiclePlateNumber: elem.vehiclePlateNumber,
      VehicleEnglishName: elem.vehicleEnglishName,
      ChassisNumber: elem.chassisNumber,
      VehicleColorEnglish: elem.vehicleColorEnglish,
    };
  });
