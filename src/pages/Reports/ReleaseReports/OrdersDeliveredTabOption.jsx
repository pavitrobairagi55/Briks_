...
export default function OrdersDeliveredTabOption() {
  ...
  useEffect(() => {
    let urlapi = "api/CustomerOrders/delivered-orders-report-data?";
    let urlPDFlink = "/api/CustomerOrders/delivered-orders-report?";
    let urlEXCELlink = "/api/CustomerOrders/delivered-orders-report-excel?";
    ...
    <>
      <HeaderFilter
        ...
        onPrint={() =>
          handlePrint(
            urlPDF,
            `Orders-Delivered-report-${formatDate(new Date())}.pdf`,
            auth
          )
        }
        export={true}
        ...
        onExport={() =>
          handleExcel(
            urlEXCEL,
            `Orders-Delivered-excel-report-${formatDate(new Date())}.xlsx`,
            auth
          )
        }
      />
