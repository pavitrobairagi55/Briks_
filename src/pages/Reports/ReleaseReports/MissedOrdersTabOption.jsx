...
export default function MissedOrdersTabOption() {
  ...
  useEffect(() => {
    let urlapi = "api/CustomerTrips/missed-orders-report-data?";
    let urlPDFlink = "/api/CustomerTrips/missed-orders-report?";
    let urlEXCELlink = "/api/CustomerTrips/missed-orders-report-excel?";
  ...
  const rows = data?.map((elem) => {
    return {
      ...
      AllocatedTimeSlot: elem.arrivalTime,
    };
  });
    ...
    <>
      <HeaderFilter
        ...
        onPrint={() =>
          handlePrint(
            urlPDF,
            `Missing-Orders-report-${formatDate(new Date())}.pdf`,
            auth
          )
        }
        export={true}
        ...
        onExport={() =>
          handleExcel(
            urlEXCEL,
            `Missing-Orders-excel-report-${formatDate(new Date())}.xlsx`,
            auth
          )
        }
      />
