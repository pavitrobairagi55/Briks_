...
import ApproveStorageModal from "../modals/ApproveStorageModal";
import { VITE_FILE_URL } from "../../../envirement";
import ApproveApprovalModal from "../modals/ApproveApprovalModal";
...
export default function ApprovalTAB() {
  ...
  const row = data?.map((elem) => {
    const file = VITE_FILE_URL + elem.wireDocument.path;
