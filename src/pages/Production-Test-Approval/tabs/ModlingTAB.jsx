...
export default function ModlingTAB() {
  ...
  const headCells = [
    ...
    {
      id: "BricksProductionOrderId",
      numeric: true,
      disablePadding: false,
      label: "Bricks Production Order Id",
    },
    {
      id: "MoldingDate",
      numeric: true,
  ...
  const row = data?.map((elem) => {
    return {
      ...
      BricksProductionOrderId: elem.bricksProductionOrder.id,
  ...
  return (
    <>
      ...
      {isEditStatusModalOpen && (
        <ApproveMoldingModal
          title="Molding Requests Approval"
          withCancel
