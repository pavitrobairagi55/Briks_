...
import ApprovePasterAndMorterModal from "../modals/ApprovePasterAndMorterModal";

export default function PlasterAndMorterTAB() {
  ...
  return (
    <>
      ...
      {isEditStatusModalOpen && (
        <ApprovePasterAndMorterModal
          title="Paster And MorterApproval"
          withCancel
