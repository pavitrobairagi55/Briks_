...
export default function ApprovePasterAndMorterModal({
  title,
  closeModal,
  saveFcn,
  type,
  ...
  const saveData = async () => {
    ...
    let url =
      status.toLowerCase() === "accepted"
        ? `api/PlasterMortarProduction/production-order/${data.id}/approve`
        : status.toLowerCase() === "rejected"
        ? `api/PlasterMortarProduction/production-order/${data.id}/reject`
        : null;
