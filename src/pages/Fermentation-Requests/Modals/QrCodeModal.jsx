              ...
              <tbody>
                <tr>
                  ...
                  <td className="border p-2">
                    {this.props.data.plasterOrMortar}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="border p-2">Stock Pile No:</td>
                  <td className="border p-2">{this.props.data.stockPileNo}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="border p-2">Red Clay:</td>
                  <td className="border p-2">
                    {this.props.data.redClayPercentage}
                  </td>
                </tr>
                <tr>
                  <td className="border p-2">Mix Design:</td>
                  <td className="border p-2">{this.props.data.mixDesgin}</td>
                </tr>
                <tr>
                  <td className="border p-2">Batch Number:</td>
...
export default function QrCodeModal({
  ...
  const { data: qrData } = useFetch(`PlasterMortarProduction/${data.id}`);
